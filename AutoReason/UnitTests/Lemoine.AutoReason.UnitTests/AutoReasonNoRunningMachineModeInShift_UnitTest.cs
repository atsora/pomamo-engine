...
using Lemoine.Plugin.AutoReasonNoRunningMachineModeInShift;
...
{
  /// <summary>
  /// Unit tests for the class AutoReasonNoRunningMachineModeInShift
  /// </summary>
  [TestFixture]
  public class AutoReasonNoRunningMachineModeInShift_UnitTest : Lemoine.UnitTests.WithSecondTimeStamp
  {
    static readonly ILog log = LogManager.GetLogger (typeof (AutoReasonNoRunningMachineModeInShift_UnitTest).FullName);

    /// <summary>
    /// Constructor
    /// </summary>
    public AutoReasonNoRunningMachineModeInShift_UnitTest () : base (DateTime.Today.AddDays (-1))
    {
    ...
    /// </summary>
    [Test]
    public void NoRunningMachineModeInShift_SimpleDetection ()
    {
    ...
    /// </summary>
    [Test]
    public void NoRunningMachineModeInShift_DetectionWithNoFacts ()
    {
      using (var session = ModelDAOHelper.DAOFactory.OpenSession ()) {
        using (var transaction = session.BeginTransaction ()) {
          try {
    ...
    /// </summary>
    [Test]
    public void NoRunningMachineModeInShift_DetectionWithFragments ()
    {
      using (var session = ModelDAOHelper.DAOFactory.OpenSession ()) {
        using (var transaction = session.BeginTransaction ()) {
          try {
    ...
    /// </summary>
    [Test]
    public void NoRunningMachineModeInShift_DetectionWithFactsAcrossShifts ()
    {
      using (var session = ModelDAOHelper.DAOFactory.OpenSession ()) {
        using (var transaction = session.BeginTransaction ()) {
          try {
    ...
    /// </summary>
    [Test]
    public void NoRunningMachineModeInShift_TwoKindsOfIdle ()
    {
      using (var session = ModelDAOHelper.DAOFactory.OpenSession ()) {
        using (var transaction = session.BeginTransaction ()) {
          try {
    ...
    /// </summary>
    [Test]
    public void NoRunningMachineModeInShift_TwoShiftsWithoutProduction ()
    {
      using (var session = ModelDAOHelper.DAOFactory.OpenSession ()) {
        using (var transaction = session.BeginTransaction ()) {
          try {
    ...
    {
      var plugin = new Lemoine.Plugin.AutoReasonNoRunningMachineModeInShift.Plugin ();
      plugin.Install (0);
