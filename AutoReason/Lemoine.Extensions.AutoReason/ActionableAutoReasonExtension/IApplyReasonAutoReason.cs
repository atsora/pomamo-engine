...
namespace Lemoine.Extensions.AutoReason.ActionableAutoReasonExtension
{
  ...
  /// 
  /// </summary>
  public interface IApplyReasonAutoReason : IAutoReasonExtension
  {
    /// <summary>
    /// Apply the associated reason (and score) to the specified range 
    /// and with the dynamic times with the aggressive mode
    /// 
    ...
    void ApplyReason (IMachine machine, IReason reason, double reasonScore, UtcDateTimeRange range, string dynamic, string details, bool overwriteRequired);
  }
}
