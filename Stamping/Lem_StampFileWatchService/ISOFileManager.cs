...
namespace Lemoine.Stamping.Lem_StampFileWatchService
{
  ...
  public class ISOFileManager : ThreadClass, IThreadClass
  {
    ...
    static readonly string ISO_FILE_PROGRESS_EXTENSION_KEY = "StampFileWatchService.FileProgressExtension";
    static readonly string ISO_FILE_PROGRESS_EXTENSION_DEFAULT = ".stamp_in_progress";
    static readonly string ERROR_FILE_EXTENSION_KEY = "StampFileWatchService.ErrorExtension";
    static readonly string ERROR_FILE_EXTENSION_DEFAULT = ".stamp_error";
    static readonly string TEMP_DIRECTORY_KEY = "StampFileWatchService.StampingTempDirectory";
    static readonly string TEMP_DIRECTORY_DEFAULT = "C:\\temp";
    static readonly string LEM_STAMP_PROCESS_NAME_KEY = "StampFileWatchService.LemStampProcess";
    static readonly string LEM_STAMP_PROCESS_NAME_DEFAULT = "";
    static readonly string PPR_TAG_PREFIX_KEY = "StampFileWatchService.PPR.";
    ...
    public void ProcessIsoFile ()
    {
      ...
      log.InfoFormat ("ProcessIsoFile: read PPR from config: PPR={0} destination={1}", programPPR, finalDestinationFullPath);
