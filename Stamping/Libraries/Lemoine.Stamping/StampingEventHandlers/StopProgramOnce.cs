...
{
  /// <summary>
  /// Stop the program only once
  /// </summary>
  public class StopProgramOnce
    : IStampingEventHandler
  {
    readonly ILog log = LogManager.GetLogger (typeof (StopProgramOnce).FullName);
    ...
    /// Constructor
    /// </summary>
    public StopProgramOnce (IStamper stamper)
    {
