...
{
  /// <summary>
  /// Sequence at tool change
  /// </summary>
  public class SequenceAtToolChange
    : IStampingEventHandler
  {
    readonly ILog log = LogManager.GetLogger (typeof (SequenceAtToolChange).FullName);

    /// <summary>
    /// Constructor
    /// </summary>
    public SequenceAtToolChange (IStamper stamper)
    {
