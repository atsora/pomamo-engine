...
{
  /// <summary>
  /// Add a comment at the end of the sequence with the total sequence duration time
  /// </summary>
  public class SequenceDurationAtEndWriter
    : IStampingEventHandler
  {
    readonly ILog log = LogManager.GetLogger (typeof (SequenceDurationAtEndWriter).FullName);

    /// <summary>
    /// Constructor
    /// </summary>
    public SequenceDurationAtEndWriter (IStamper stamper, StampingData stampingData)
    {
