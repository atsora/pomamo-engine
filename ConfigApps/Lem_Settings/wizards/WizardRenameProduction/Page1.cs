...
namespace WizardRenameProduction
{
  ...
  internal partial class Page1 : GenericWizardPage, IWizardPage
  {
    ...
    /// </summary>
    public string Help { get { return "Choose the line in which you want to rename a production period."; } }
    ...
    public void LoadPageFromData(ItemData data)
    {
      ...
      if (line != null && listLines.ContainsObject(line)) {
        listLines.SelectedValue = line;
      }
      else {
