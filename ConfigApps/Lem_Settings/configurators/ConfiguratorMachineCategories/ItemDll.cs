...
namespace ConfiguratorMachineCategories
{
  ...
  public class ItemDll: IItemDll
  {
    ...
    public IList<IItem> CreateItems(ItemContext context)
    {
      ...
      items.Add(new ItemCompany() as IItem);
      items.Add(new ItemDepartment() as IItem);
      items.Add(new ItemCategory() as IItem);
      items.Add(new ItemSubcategory() as IItem);
      items.Add(new ItemCell() as IItem);
      return items;
    }
