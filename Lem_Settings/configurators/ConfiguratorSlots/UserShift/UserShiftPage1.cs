...
{
  /// <summary>
  /// Description of UserShiftPage1.
  /// </summary>
  public class UserShiftPage1 : IPartPage1
  {
    ...
    public string HelpSub {
      get { return "This page comprises a timeline per user, representing its shift planning. " +
    ...
    public void AddTimeLine(TimelinesWidget timelines, object item)
    {
      ...
      if (user != null) {
        timelines.AddTimeline(user.Display, new UserShiftBarData(user));
      }
    }
    #endregion // Methods
  }
