...
namespace ConfiguratorSlots
{
  ...
  public class ItemDll: IItemDll
  {
    ...
    public IList<IItem> CreateItems(ItemContext context)
    {
      ...
      items.Add(new MachineState.MachineStateItem() as IItem);
      items.Add(new ShiftTemplate.ShiftTemplateItem() as IItem);
      items.Add(new DayTemplate.DayTemplateItem() as IItem);
      items.Add(new UserShift.UserShiftItem() as IItem);
      items.Add(new UserMachine.UserMachineItem() as IItem);
      return items;
    }
