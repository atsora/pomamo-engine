...
{
  /// <summary>
  /// Description of DayTemplatePage1.
  /// </summary>
  internal class DayTemplatePage1 : IPartPage1
  {
    ...
    public string HelpSub {
      get { return "This page comprises a timeline representing " +
          "the evolution of the day template according to the time."; }
    }
    ...
    {
      timelines.AddTimeline("", new DayTemplateBarData());
    }
    #endregion // Methods
  }
}
