...
namespace Lem_Settings
{
  partial class RevisionDialog
  {
    ...
    {
      RevisionManager.UpdateDone -= OnUpdateDone;
      if (disposing) {
        if (components != null) {
          components.Dispose();
        }
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RevisionDialog));
      ...
      this.baseLayout.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 341F));
      this.baseLayout.Size = new System.Drawing.Size(384, 341);
      ...
      this.verticalScroll.Size = new System.Drawing.Size(384, 341);
