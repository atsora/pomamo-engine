...
namespace ViewTemplate
{
  ...
  internal partial class Page1 : GenericViewPage, IViewPage
  {
    ...
    /// </summary>
    public string Help { get { return "Main page: possibility to go to two other pages.\n" +
          "This page is updated each time the wizard or configurator template emit the signal " +
          "\"edited\"."; } }
