...
{
  /// <summary>
  /// Acquisition delay direction
  /// </summary>
  public enum AcquisitionDelayDirection {
    /// <summary>
    /// UP
    /// </summary>
    UP,
  ...
  /// <summary>
  /// Serializable class that lists the data of the AcquisitionDelayListener.
  /// </summary>
  [Serializable]
  public class AcquisitionDelayData
  {
    #region Members
    string m_name;
    MonitoredMachine m_machine;
    AcquisitionDelayDirection m_direction;
    string m_message;
    TimeSpan m_delay;
    ...
    static readonly ILog log = LogManager.GetLogger(typeof (AcquisitionDelayData).FullName);
    ...
    /// Default constructor
    /// </summary>
    protected AcquisitionDelayData ()
    { }
    ...
    public AcquisitionDelayData (string name, Lemoine.Model.IMonitoredMachine machine, AcquisitionDelayDirection direction,
