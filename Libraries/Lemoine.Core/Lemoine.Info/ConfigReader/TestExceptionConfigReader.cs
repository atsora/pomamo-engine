...
{
  /// <summary>
  /// Config reader with default values that can be made unavailable
  /// 
  /// When unavailable, an exception is raised
  /// 
  /// Thread safe
  /// </summary>
  public class TestExceptionConfigReader
    : IGenericConfigReader
  {
    static readonly ILog log = LogManager.GetLogger (typeof (TestExceptionConfigReader).FullName);
    ...
    /// Constructor
    /// </summary>
    public TestExceptionConfigReader ()
    {
    }
