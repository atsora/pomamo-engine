...
namespace Lemoine.Xml
{
  ...
  /// </summary>
  [Serializable]
  public sealed class XslHtmlBodyTemplateDefinition: XslDefinition
  {
    #region Members
    ...
    static readonly ILog log = LogManager.GetLogger(typeof (XslHtmlBodyTemplateDefinition).FullName);
    ...
    public string XslTemplate {
      ...
      set
      {
        try {
          ...
          log.ErrorFormat ("XslTemplate: exception {0}", ex);
          throw;
        }
      }
    }
    ...
    /// </summary>
    public XslHtmlBodyTemplateDefinition ()
    {
    }
    ...
    public XslHtmlBodyTemplateDefinition (string xslTemplate)
    {
    ...
    /// <param name="s"></param>
    /// <returns></returns>
    protected override string AddHeaderFooter (string s)
    {
