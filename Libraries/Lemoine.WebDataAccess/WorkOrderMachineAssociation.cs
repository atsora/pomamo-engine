...
{
  /// <summary>
  /// Description of WorkOrderMachineAssociation.
  /// </summary>
  public class WorkOrderMachineAssociation: IWorkOrderMachineAssociation
  {
    #region Constructors
    internal WorkOrderMachineAssociation (IMachine machine, UtcDateTimeRange range)
    {
    ...
    #endregion
    #region IWorkOrderMachineAssociation implementation
    public Lemoine.Model.IWorkOrder WorkOrder {
      get; set;
    }
    public ILine Line {
      get; set;
