...
namespace Lemoine.Extensions.Configuration.GuiBuilder.DataTypes
{
  ...
  /// </summary>
  public class BoolPluginConf : IPluginConfDataType
  {
    /// <summary>
    /// Not used
    /// </summary>
    ...
    protected void AddBoolControl (IPluginConfig pluginConfig, string name, string labelText)
    {
      pluginConfig.AddCheckBox (name, labelText);
    }
