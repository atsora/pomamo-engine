...
{
  /// <summary>
  /// Plugin conf to consider a DatePicker control to get a date
  /// </summary>
  public class DatePickerPluginConf : IPluginConfDataType
  {
    ...
    protected void AddDatePickerControl (IPluginConfig pluginConfig, string name, string labelText)
    {
      if (this.Optional) {
        pluginConfig.AddOptionalDatePicker (name, labelText);
      }
      else {
        pluginConfig.AddDatePicker (name, labelText);
      }
    }
