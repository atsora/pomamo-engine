...
{
  /// <summary>
  /// Migration 279: add the tables "ToolPosition" and "ToolLife"
  /// </summary>
  [Migration(279)]
  public class ToolLifeManagement: MigrationExt
  {
    static readonly ILog log = LogManager.GetLogger(typeof (ToolLifeManagement).FullName);
    ...
    void AddToolPositionTable()
    {
      ...
      // Foreign key
      Database.GenerateForeignKey(TableName.TOOL_POSITION, ColumnName.MACHINE_ID,
                                  TableName.MACHINE, ColumnName.MACHINE_ID,
                                  Migrator.Framework.ForeignKeyConstraint.Cascade);
      
      // [machine, magazine, pot] is unique
      AddNamedUniqueConstraint("uniqueposition", TableName.TOOL_POSITION,
    ...
    void AddToolLifeTable()
    {
      ...
      // Foreign keys
      Database.GenerateForeignKey(TableName.TOOL_LIFE, ColumnName.MACHINE_ID,
                                  TableName.MACHINE, ColumnName.MACHINE_ID,
                                  Migrator.Framework.ForeignKeyConstraint.Cascade);
    ...
    void AddEventToolLifeTable()
    {
      ...
      Database.GenerateForeignKey(TableName.EVENT_TOOL_LIFE, ColumnName.EVENT_LEVEL_ID,
                                  ...
                                  Migrator.Framework.ForeignKeyConstraint.Cascade);
      Database.GenerateForeignKey(TableName.EVENT_TOOL_LIFE, ColumnName.MACHINE_ID,
                                  TableName.MACHINE, ColumnName.MACHINE_ID,
                                  Migrator.Framework.ForeignKeyConstraint.Cascade);
