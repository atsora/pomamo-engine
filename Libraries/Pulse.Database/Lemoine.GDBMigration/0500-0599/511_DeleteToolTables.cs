...
namespace Lemoine.GDBMigration
{
  ...
  /// </summary>
  [Migration(511)]
  public class DeleteToolTables: MigrationExt
  {
    static readonly ILog log = LogManager.GetLogger(typeof (DeleteToolTables).FullName);
...
SET displaypattern='T<%ToolNumber%>'
WHERE displaytable='ToolPosition'");
    }
  }
}
