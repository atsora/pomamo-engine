...
{
  /// <summary>
  /// Persistent class of table MachineCategory
  /// </summary>
  [Serializable]
  public class MachineCategory
    : DataWithDisplayFunction
    , IMachineCategory, IVersionable
    , IComparable, IDisplayPriorityCodeNameComparerItem
  {
    ...
    static readonly ILog log = LogManager.GetLogger(typeof (MachineCategory).FullName);
    ...
    /// <summary>
    /// Set of machines sharing this category
    /// </summary>
    [XmlIgnore]
    ...
    public virtual bool Equals(IMachineCategory other)
    {
    ...
    public override bool Equals(object obj)
    {
      ...
      MachineCategory other = obj as MachineCategory;
      if (null == other) {
        return false;
      }
      if (this.Id != 0) {
    ...
    public virtual int CompareTo (object obj)
    {
      ...
      var other = obj as IMachineCategory;
      if (other != null) {
        return new DisplayPriorityCodeNameComparer<IMachineCategory, MachineCategory> ()
          .Compare (this, other);
      }
      else {
        throw new ArgumentException ("other is not a MachineCategory", "obj");
      }
    }
    #endregion // IComparable implementation
    #region IComparable<IMachineCategory> implementation
    /// <summary>
    /// <see cref="IComparable{T}"/>
    /// </summary>
    /// <param name="other"></param>
    /// <returns></returns>
    public virtual int CompareTo (IMachineCategory other)
    {
      if (other is null) {
        return int.MinValue;
      }
    ...
    /// </summary>
    public class DisplayComparer : IComparer<IMachineCategory>
    {
      /// <summary>
      ...
      /// <param name="y"></param>
      /// <returns></returns>
      int IComparer<IMachineCategory>.Compare (IMachineCategory x, IMachineCategory y)
      {
        return (new DisplayPriorityCodeNameComparer<IMachineCategory, MachineCategory> ())
          .Compare (x, y);
      }
    }
    #endregion // IComparable<IMachineCategory> implementation
  }
}
