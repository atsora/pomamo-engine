...
{
  /// <summary>
  /// Persistent class of table Cell
  /// </summary>
  [Serializable]
  public class Cell
    ...
    , IComparable, IDisplayPriorityCodeNameComparerItem
  {
    ...
    public virtual int CompareTo (object obj)
    {
      ...
      var other = obj as ICell;
      if (other != null) {
        return new DisplayPriorityCodeNameComparer<ICell, Cell> ()
          .Compare (this, other);
      }
      else {
        throw new ArgumentException ("other is not a Cell", "obj");
      }
    }
    #endregion // IComparable implementation
    #region IComparable<ICell> implementation
    /// <summary>
    /// <see cref="IComparable{T}"/>
    /// </summary>
    /// <param name="other"></param>
    /// <returns></returns>
    public virtual int CompareTo (ICell other)
    {
      if (other is null) {
        return int.MinValue;
      }
    ...
    /// </summary>
    public class DisplayComparer : IComparer<ICell>
    {
      /// <summary>
      ...
      /// <param name="y"></param>
      /// <returns></returns>
      int IComparer<ICell>.Compare (ICell x, ICell y)
      {
        return (new DisplayPriorityCodeNameComparer<ICell, Cell> ())
          .Compare (x, y);
      }
    }
    #endregion // IComparable<ICell> implementation
  }
}
