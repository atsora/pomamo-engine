...
{
  /// <summary>
  /// Persistent class of table UserMachineSlotMachine
  /// </summary>
  [Serializable]
  public class UserMachineSlotMachine: IUserMachineSlotMachine, ISerializableModel, IDataWithId
  {
    #region Members
    int m_id = 0;
    IMachine m_machine;
    ...
    static readonly ILog log = LogManager.GetLogger(typeof (UserMachineSlotMachine).FullName);

    #region Constructors
    /// <summary>
    /// Default constructor
    /// </summary>
    protected UserMachineSlotMachine ()
    {
    }
    ...
    internal UserMachineSlotMachine (IMachine machine, IMachineStateTemplate machineStateTemplate)
    {
    ...
    {
      UserMachineSlotMachine other = obj as UserMachineSlotMachine;
      if (other == null) {
        return false;
      }
