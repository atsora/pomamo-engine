...
{
  /// <summary>
  /// Persistent class of table CncDataImportLog
  /// </summary>
  [Serializable]
  public class CncDataImportLog : Log, ICncDataImportLog
  {
    #region Members
    IMachine m_machine;
    ...
    static readonly ILog log = LogManager.GetLogger (typeof (CncDataImportLog).FullName);
    ...
    internal CncDataImportLog (LogLevel level,
                                 string message,
                                 IMachine machine,
    ...
    /// </summary>
    internal protected CncDataImportLog ()
    {
    }
