...
namespace Lemoine.Business.CncAlarm
{
  ...
  /// </summary>
  [Serializable]
  public class CncAlarmColor : ICncAlarmColor
  {
    ILog log = LogManager.GetLogger (typeof (CncAlarmColor).FullName);
    ...
    protected internal CncAlarmColor (IMonitoredMachine machine,
                                      string color,
    ...
    protected internal CncAlarmColor (ICncAlarm cncAlarm)
      : this (cncAlarm.MachineModule.MonitoredMachine, cncAlarm.Color, cncAlarm.DateTimeRange, cncAlarm.DateTimeRange.Duration)
    {
    }
    ...
    protected internal CncAlarmColor (ICncAlarm cncAlarm, UtcDateTimeRange dateTimeRange)
      : this (cncAlarm.MachineModule.MonitoredMachine, cncAlarm.Color, dateTimeRange, dateTimeRange.Duration)
    {
    }
    ...
    /// <returns></returns>
    public virtual bool ReferenceDataEquals (ICncAlarmColor other)
    {
      if (other == null) {
        return false;
      }
    ...
    {
      if (obj is CncAlarmColor) {
        ICncAlarmColor other = (ICncAlarmColor)obj;
    ...
    /// <param name="other"></param>
    /// <returns></returns>
    public virtual int CompareTo (ICncAlarmColor other)
    {
      if (other.Machine.Equals (this.Machine)) {
        return this.DateTimeRange.CompareTo (other.DateTimeRange);
      }
      ...
      log.ErrorFormat ("CompareTo: " +
                       "trying to compare CncAlarmColor " +
                       "for different machines {0} {1}",
                       this, other);
      throw new ArgumentException ("Comparison of CncAlarmColor from different machines");
    }
    ...
    public virtual bool Equals (ICncAlarmColor other)
    {
    ...
    public override bool Equals (object obj)
    {
      ...
      CncAlarmColor other = obj as CncAlarmColor;
      if (null == other) {
        return false;
      }
      return object.Equals (this.Machine, other.Machine)
    ...
    {
      return string.Format ("[CncAlarmColor Machine={0} Field={1} Range={2}]",
    ...
    /// <param name="duration"></param>
    /// <returns></returns>
    public ICncAlarmColor Clone (UtcDateTimeRange range, TimeSpan? duration)
    {
      ICncAlarmColor clone = new CncAlarmColor (this.Machine,
                                                this.Color,
                                                range,
                                                duration);
      return clone;
