...
namespace Lemoine.Core.Plugin.TargetSpecific
{
    ...
    : IAssemblyLoader
  {
    ...
    readonly ILog log = LogManager.GetLogger (typeof (AssemblyLoader).FullName);
    readonly ILog successLog = LogManager.GetLogger ($"{typeof (AssemblyLoader).FullName}.Success");
    ...
    public Assembly LoadFromCurrentDomain (AssemblyName assemblyName)
    {
      ...
      return loadContext.LoadFromCurrentDomain (assemblyName);
    }
...
#if (NET5_0_OR_GREATER || NETCOREAPP3_1 || (NETCOREAPP && !NETCOREAPP3_0 && !NETCOREAPP2_2 && !NETCOREAPP2_1 && !NETCOREAPP2_0 && !NETCOREAPP1_1 && !NETCOREAPP1_0))
