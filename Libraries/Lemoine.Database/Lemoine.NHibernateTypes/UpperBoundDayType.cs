...
namespace Lemoine.NHibernateTypes
{
  ...
  /// </summary>
  [Serializable]
  public class UpperBoundDayType: SimpleGenericType<UpperBound<DateTime>>
  {
    static readonly ILog log = LogManager.GetLogger(typeof (UpperBoundDayType).FullName);
    
    /// <summary>
    /// Constructor
    /// </summary>
    public UpperBoundDayType ()
      : base (new SqlType (DbType.Date), NpgsqlTypes.NpgsqlDbType.Date, false)
    {
    }
