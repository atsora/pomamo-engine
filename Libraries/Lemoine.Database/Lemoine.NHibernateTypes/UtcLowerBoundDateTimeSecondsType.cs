...
{
  /// <summary>
  /// Use LowerBound&lt;DateTime&gt; as Object in SQL that is truncated to the second
  /// </summary>
  [Serializable]
  public sealed class UtcLowerBoundDateTimeSecondsType : SimpleGenericType<LowerBound<DateTime>>
  {
    static readonly ILog log = LogManager.GetLogger (typeof (UtcLowerBoundDateTimeSecondsType).FullName);

    /// <summary>
    /// Constructor
    /// </summary>
    public UtcLowerBoundDateTimeSecondsType ()
    ...
    {
      get { return "UtcLowerBoundDateTimeSeconds"; }
    }
