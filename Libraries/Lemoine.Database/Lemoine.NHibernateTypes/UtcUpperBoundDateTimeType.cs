...
{
  /// <summary>
  /// Use UpperBound&lt;DateTime&gt; as Object in SQL
  /// </summary>
  [Serializable]
  [Obsolete ("Use UtcUpperBoundDateTimeSecondsType or UtcUpperBoundDateTimeFullType instead", false)]
  public sealed class UtcUpperBoundDateTimeType : SimpleGenericType<UpperBound<DateTime>>
  {
    static readonly ILog log = LogManager.GetLogger (typeof (UtcUpperBoundDateTimeType).FullName);

    /// <summary>
    /// Constructor
    /// </summary>
    public UtcUpperBoundDateTimeType ()
    ...
    {
      get { return "UtcUpperBoundDateTime"; }
    }
