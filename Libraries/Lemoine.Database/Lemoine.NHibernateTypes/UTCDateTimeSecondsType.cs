...
namespace Lemoine.NHibernateTypes
{
  ...
  /// </summary>
  [Serializable]
  public sealed class UTCDateTimeSecondsType : GenericDateTimeType
  {
    static readonly ILog log = LogManager.GetLogger (typeof (UTCDateTimeSecondsType).FullName);
