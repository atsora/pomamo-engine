...
{
  /// <summary>
  /// NHibernate type to get a local day object
  /// </summary>
  [Serializable]
  public class LocalDayType: DateTimeType
  {
    static readonly ILog log = LogManager.GetLogger(typeof (LocalDayType).FullName);
