...
{
  /// <summary>
  /// NHibernate Type for InitialNullIdSortedSet
  /// see NHibernate documentation for NHibernate.Type.GenericSetType.cs
  /// </summary>
  public class InitialNullIdSortedSetType<T, ID> :
    ...
    where T : IComparable
  {
    ...
    readonly ILog log = LogManager.GetLogger(typeof (InitialNullIdSortedSetType<T, ID>).FullName);
    ...
    /// <summary>
    /// instantiate an InitialNullIdSortedSet with an anticipated size
    /// </summary>
    /// <param name="anticipatedSize"></param>
    /// <returns></returns>
    public object Instantiate(int anticipatedSize)
    {
      return new InitialNullIdSortedSet<T, ID>();
    }
