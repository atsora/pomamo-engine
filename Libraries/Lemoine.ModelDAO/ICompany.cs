...
{
  /// <summary>
  /// Model for table Company
  /// </summary>
  public interface ICompany: IDataWithIdentifiers, IDisplayable, ISelectionable, IDataWithVersion
    , ISerializableModel
    , IMachineFilterItemSet
    , IComparable
  {
    // Note: ICompany does not inherit from IVersionable
    ...
    /// <summary>
    /// Machines that are associated to this company
    /// </summary>
