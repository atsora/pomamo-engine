...
{
  /// <summary>
  /// .NET Core version of CacheClientWithCleanExtension
  /// </summary>
  public sealed class CacheClientWithCleanExtensionCore : ICacheClientWithCleanExtension
  {
    #region Members
    ...
    static readonly ILog log = LogManager.GetLogger (typeof (CacheClientWithCleanExtensionCore).FullName);
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.StartBatchUpdate")) {
    ...
    public void FinishBatchUpdate ()
    {
      ...
      using (new PerfTracker ("Cache.WithCleanCore.FinishBatchUpdate")) {
        try {
          try {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.Remove")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.RemoveAll")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.Get")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.Increment")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.Decrement")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.Add")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.Set")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.Replace")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.AddExpiresAt")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.SetExpiresAt")) {
        AddKeyExpiration (key, expiresAt);
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.ReplaceExpiresAt")) {
        AddKeyExpiration (key, expiresAt);
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.AddExpiresIn")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.SetExpiresIn")) {
        AddKeyExpiration (key, DateTime.UtcNow.Add (expiresIn));
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.ReplaceExpiresIn")) {
        AddKeyExpiration (key, DateTime.UtcNow.Add (expiresIn));
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.FlushAll")) {
        ClearBatchUpdatePendingRegexes ();
        m_keyExpiration.Clear ();
        m_expirationKeys.Clear ();
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.GetAll")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.SetAll")) {
    ...
    {
      using (new PerfTracker ("Cache.WithCleanCore.RemoveByRegex")) {
        CleanCache (); // To limit the number of keys to inspect
