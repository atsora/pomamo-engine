...
namespace Pulse.Web.Reason
{
  ...
  /// Request DTO
  /// </summary>
  [Api("Request DTO for /ReasonColorSlots service")]
  [ApiResponse(HttpStatusCode.InternalServerError, "Oops, something broke")]
  [Route("/ReasonColorSlots/", "GET", Summary = "Get the reason color slots in a specified range", Notes = "To use with ?MachineId=&Range= or ?GroupId=&Range=")]
  [Route("/ReasonColorSlots/Get/{GroupId}/{Range}", "GET", Summary = "Get the reason color slots in a specified range", Notes = "")]
  [Route("/Reason/ColorSlots/", "GET", Summary = "Get the reason color slots in a specified range", Notes = "To use with ?MachineId=&Range= or ?GroupId=&Range=")]
  [Route("/Reason/ColorSlots/Get/{GroupId}/{Range}", "GET", Summary = "Get the reason color slots in a specified range", Notes = "")]
  public class ReasonColorSlotsRequestDTO: IReturn<ReasonColorSlotsResponseDTO>
  {
    /// <summary>
    /// Machine Id
    /// </summary>
