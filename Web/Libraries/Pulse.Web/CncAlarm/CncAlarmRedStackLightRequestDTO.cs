...
namespace Pulse.Web.CncAlarm
{
  ...
  /// Request DTO
  /// </summary>
  [Api ("Request DTO for /CncAlarm/RedStackLight service")]
  [ApiResponse (HttpStatusCode.InternalServerError, "Oops, something broke")]
  [Route ("/CncAlarm/RedStackLight/", "GET", Summary = "Get the cnc alarm color + red stack light slots in a specified range", Notes = "To use with ?MachineId=&Range=")]
  [Route ("/CncAlarm/RedStackLight/Get/{MachineId}/{Range}", "GET", Summary = "Get the cnc alarm color + red stack light slots in a specified range")]
  public class CncAlarmRedStackLightRequestDTO : IReturn<CncAlarmRedStackLightResponseDTO>
  {
    /// <summary>
    /// Id of the machine
    /// </summary>
