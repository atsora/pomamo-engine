...
namespace Pulse.Web.CncValue
{
  ...
  /// Request DTO
  /// </summary>
  [Api ("Request DTO for /CncValue/RedStackLight service")]
  [ApiResponse (HttpStatusCode.InternalServerError, "Oops, something broke")]
  [Route ("/RedStackLight", "GET", Summary = "Get the red stack light slots in a specified range", Notes = "To use with ?MachineId=&Range=&FieldId= or ?MachineModuleId=&Range=")]
  [Route ("/CncValue/RedStackLight", "GET", Summary = "Get the red stack light slots in a specified range", Notes = "To use with ?MachineId=&Range=&FieldId= or ?MachineModuleId=&Range=")]
  public class RedStackLightRequestDTO
