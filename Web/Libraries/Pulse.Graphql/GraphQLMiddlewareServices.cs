  ...
  public static class GraphQLMiddlewareServices
  {
    ...
    public static IServiceCollection ConfigureServices (IServiceCollection services)
    {
      ...
      return services
        ...
        .AddSingleton<CncConfigParamValueInputType> ()
        .AddSingleton<NewCncAcquisitionInputType> ()
        .AddSingleton<NewJobInputType> ()
        .AddSingleton<NewProjectInputType> ()
        .AddSingleton<NewWorkOrderInputType> ()
        .AddSingleton<UpdateCncAcquisitionInputType> ()
        ...
        .AddSingleton<CncConfigProtocolGraphType> ()
        .AddSingleton<CncConfigParamGraphType> ()
        .AddSingleton<CncConfigParamValueGraphType> ()
