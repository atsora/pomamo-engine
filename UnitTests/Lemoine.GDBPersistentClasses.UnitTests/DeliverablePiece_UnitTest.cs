    ...
    public void TestDeliverablePiece()
    {
      try {
          ...
          using (ITransaction transaction = session.BeginTransaction ())
        {
          ...
          Assert.AreEqual(deliverablePiece1, deliverablePiece2);
          ...
          Assert.IsTrue(deliverablePieceList1.Contains(deliverablePiece1));
          ...
          Assert.IsFalse(deliverablePieceList2.Contains(deliverablePiece1));
