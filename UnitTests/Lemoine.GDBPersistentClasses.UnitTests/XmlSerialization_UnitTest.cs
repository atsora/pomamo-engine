        ...
        using (var xmlWriter = XmlWriter.Create (stringWriter, new XmlWriterSettings { Indent = false })) {
          ...
          using (IDAOSession session = ModelDAOHelper.DAOFactory.OpenSession ()) {
            using (IDAOTransaction transaction = session.BeginTransaction ()) {
              ...
              // The display of a field is computed by the database from the translation table and the
              // i18n.locale.default configuration: it depends on the language of the installation
  ...
  <MachineObservationState TranslationKey=""MachineObservationStateAttended"" Display=""Machine ON with operator (attended)"" UserRequired=""true"" ShiftRequired=""false"" OnSite=""true"" IsProduction=""true"" IsSetup=""false"" />
    ...
    public void TestEventCncValueSerialization ()
    {
      ...
      using (IDAOSession daoSession = daoFactory.OpenSession ()) {
        ...
        // The display of a field is computed by the database from the translation table and the
        // i18n.locale.default configuration: it depends on the language of the installation
        fieldDisplay = ((IEventCncValue)ev).Field.Display;
      }
      {
        XmlSerializer serializer = new XmlSerializer (typeof (Event));
        using (var stringWriter = new StringWriter ()) {
...
#if NET6_0_OR_GREATER
            Assert.That (s.ReplaceLineEndings (), Is.EqualTo ($"""
<?xml version="1.0" encoding="utf-16"?><EventCncValue xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" DateTime="2012-12-12 00:00:00" LocalDateTimeString="12/12/2012 01:00:00" LocalDateTimeG="12/12/2012 01:00:00" Message="message" Duration="00:20:00"><Level Name="" TranslationKey="EventLevelAlert" Display="Alert" Priority="100" /><MachineModule Id="1" Name="machinemodule-1" ConfigPrefix=""><CncAcquisition Id="1" Name="MACHINE_A17" ConfigPrefix="" ConfigKeyParams="null" UseProcess="false" StaThread="false" UseCoreService="false" Every="00:00:02" NotRespondingTimeout="00:02:00" SleepBeforeRestart="00:00:10" License="0"><Computer Id="1" Name="PC17" Address="PC17" IsLctr="true" IsLpst="true" IsCnc="false" IsWeb="true" IsAutoReason="false" IsAlert="true" IsSynchronization="true" /></CncAcquisition><MonitoredMachine Id="1" Name="MACHINE_A17"><MonitoringType TranslationKey="MonitoringTypeMonitored" Display="Monitored" Id="2" /></MonitoredMachine></MachineModule><MonitoredMachine Id="1" Name="MACHINE_A17"><MonitoringType TranslationKey="MonitoringTypeMonitored" Display="Monitored" Id="2" /></MonitoredMachine><Field Display="{fieldDisplay}" TranslationKey="FieldFeedrateOverride" Code="FeedrateOverride" Type="Double" /><Value xsi:type="xsd:double">80</Value></EventCncValue>
""".ReplaceLineEndings ()));
#else // NET48
        Assert.AreEqual (@"<?xml version=""1.0"" encoding=""utf-16""?>
...
<OpSequence xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" Order="0" AutoOnly="true" Frequency="1" Kind="Machining">
  <Path Number="1">
    <Operation Name="SFKPROCESS1" MachiningDurationSource="Manual" MachiningDuration="01:00:00" MachiningHours="1" SetUpHours="0" TearDownHours="0" LoadingDurationSource="Manual" LoadingHours="0" UnloadingHours="0">
