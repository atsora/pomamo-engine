...
{
  partial class MachineModeSelection
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.treeView = new Lemoine.DataReferenceControls.RecursiveTreeView();
      ...
      // treeView
      // 
      this.treeView.DisplayedProperty = null;
      this.treeView.Dock = System.Windows.Forms.DockStyle.Fill;
      this.treeView.Location = new System.Drawing.Point(0, 0);
      this.treeView.Margin = new System.Windows.Forms.Padding(0);
      this.treeView.Name = "treeView";
      this.treeView.NodeIsSelectable = true;
      this.treeView.ParentProperty = "Parent";
      this.treeView.Size = new System.Drawing.Size(342, 204);
      this.treeView.TabIndex = 3;
      this.treeView.SelectionChanged += new System.Action(this.TreeViewSelectionChanged);
      // 
      ...
      this.Name = "MachineModeSelection";
      this.Size = new System.Drawing.Size(342, 234);
      this.Load += new System.EventHandler(this.MachineModeSelectionLoad);
    ...
    private Lemoine.DataReferenceControls.RecursiveTreeView treeView;
  }
}
