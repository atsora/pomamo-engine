...
{
  /// <summary>
  /// RichTextBox in which we can add urls programmatically
  /// Urls may have a link + a displayed text
  /// </summary>
  public class RichTextBoxExtended : RichTextBox
  {
    ...
    /// <summary>
    /// Must remain to false otherwise interactions may occur with custom urls
    /// </summary>
    [DefaultValue(false)]
