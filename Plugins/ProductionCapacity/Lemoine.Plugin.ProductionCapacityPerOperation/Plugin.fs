...
type Plugin() =
  ...
  let log = LogManager.GetLogger "Lemoine.Plugin.ProductionCapacityPerOperation.Plugin"

  override this.Name = "Production Capacity per operation"
  override this.Description = "Production Capacity per operation"
