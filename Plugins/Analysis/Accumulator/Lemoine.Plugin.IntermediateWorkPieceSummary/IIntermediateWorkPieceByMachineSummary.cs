...
{
  /// <summary>
  /// Model for the table iwpbymachinesummary
  /// 
  /// This contains various information on an intermediate work piece by machine
  /// </summary>
  public interface IIntermediateWorkPieceByMachineSummary
    : IDataWithVersion, IPartitionedByMachine
  {
    /// <summary>
