...
namespace Lemoine.Plugin.AnalysisStateMachineNoOperationDetection
{
    ...
    : Lemoine.Extensions.Configuration.IConfiguration
  {
    ...
    [PluginConf ("DurationPicker", "Pending modifications maximum time", Description = "Maximum time for the analysis of the pending modifications. Default is 0:00:15", Parameters = "0:00:10")]
    ...
    public Configuration()
    {
      ...
      this.PendingModificationsMaxTime = TimeSpan.FromSeconds (15);
