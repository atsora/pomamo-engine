...
namespace Lemoine.Plugin.AnalysisStateMachineNoOperationDetection
{
    ...
    , IMonitoredMachineActivityAnalysisStateMachineExtension
  {
    ...
    public bool Initialize(IMonitoredMachineActivityAnalysis context)
    {
      ...
      var processingState1 = new AnalysisState<IMonitoredMachineActivityAnalysis> ("ProcessingReasonSlots1", "ProcessingReasonSlots", (c, t) => c.RunProcessingReasonSlotsAnalysis (t), nextState, nextState, maxTimeState: endState);
      var beforeProcessingState1 = new CheckMaxTime<IMonitoredMachineActivityAnalysis> (endState, processingState1);
      var modificationsState1 = new AnalysisState<IMonitoredMachineActivityAnalysis> ("PendingModifications1", "PendingModificationsHigh", (c, t) => c.RunPendingModificationsAnalysis (t, highPriority, highPriority), beforeProcessingState1, beforeProcessingState1, maxTimeState: endState);
      var beforeModificationsState1 = new CheckMaxTime<IMonitoredMachineActivityAnalysis> (endState, modificationsState1);
      nextState = new AnalysisState<IMonitoredMachineActivityAnalysis> ("ProcessingReasonSlots", (c, t) => c.RunProcessingReasonSlotsAnalysis (t), beforeModificationsState1, beforeModificationsState1, maxTimeState: endState);
