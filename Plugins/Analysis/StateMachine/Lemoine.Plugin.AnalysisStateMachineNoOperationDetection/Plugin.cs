...
namespace Lemoine.Plugin.AnalysisStateMachineNoOperationDetection
{
  public class Plugin : PluginWithAutoConfig<Configuration>, IPluginDll, IFlaggedPlugin
  {
    ...
    /// </summary>
    public override string Name { get { return "AnalysisStateMachineNoOperationDetection"; } }
    ...
    {
      get {
        return "Analysis state machine for a basic system with no operation detection (but manual or auto reasons)";
      }
    }
