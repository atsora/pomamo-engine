...
namespace Lemoine.Plugin.AnalysisStateMachineProductionShop
{
    ...
    , IMachineActivityAnalysisStateMachineExtension
  {
    ...
    public bool Initialize (IMachineActivityAnalysis context)
    {
      ...
      nextState = new AnalysisState<IMachineActivityAnalysis> ("OperationSlotSplit", (c, t) => c.RunOperationSlotSplitAnalysis (t), nextState, nextState, maxTimeState: endState);
      nextState = new AnalysisState<IMachineActivityAnalysis> ("Production", (c, t) => c.RunProductionAnalysis (t), nextState, nextState, maxTimeState: nextState);
