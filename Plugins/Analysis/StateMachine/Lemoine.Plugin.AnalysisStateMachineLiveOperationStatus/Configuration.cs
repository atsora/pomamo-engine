...
namespace Lemoine.Plugin.AnalysisStateMachineLiveOperationStatus
{
    ...
    , Lemoine.Extensions.Configuration.IConfiguration
  {
    ...
    [PluginConf ("DoubleAsNumericUpDown", "ConfigPriority. Default is 50.0", Description = "Config priority", Parameters = "99999.99")]
    [DefaultValue (50.0)]
    ...
    [PluginConf ("DurationPicker", "Maximum time", Description = "Maximum time for the state machine execution. Default is 0:00:40", Parameters = "0:00:10")]
    ...
    [PluginConf ("DurationPicker", "Auto-sequences analysis maximum time", Description = "Maximum time for the analysis of the auto-sequences. Default is 0:01:00", Parameters = "0:00:10")]
    [DefaultValue ("0:01:00")]
    ...
    {
      this.ConfigPriority = 50.0;
      this.StateMachinePriority = 20.0;
      this.MaxTime = TimeSpan.FromSeconds (40);
      ...
      this.AutoSequencesMaxTime = TimeSpan.FromSeconds (60);
    }
