...
namespace Lemoine.Plugin.GroupCompany
{
    ...
    : Lemoine.Extensions.Configuration.IConfiguration
  {
    ...
    /// Category name
    /// </summary>
    [PluginConf ("Text", "Group Category Name", Description = "a name for the group. Default: Company")]
    ...
    /// </summary>
    [PluginConf ("Text", "ID prefix", Description = "a prefix for the ID. Default: C")]
    [DefaultValue ("C")]
