...
namespace Lemoine.Plugin.GroupMachineSubCategory
{
    ...
    : Lemoine.Extensions.Configuration.IConfiguration
  {
    ...
    /// Category name
    /// </summary>
    [PluginConf ("Text", "Group Category Name", Description = "a name for the group. Default: Machine sub-category")]
    [DefaultValue ("Machine sub-category")]
    ...
    /// </summary>
    [PluginConf ("Text", "ID prefix", Description = "a prefix for the ID. Default: SC")]
    [DefaultValue ("SC")]
    ...
    /// </summary>
    [PluginConf ("Double", "Sort priority", Description = "a sort priority. Default value: 10.0")]
    [DefaultValue (10.0)]
