...
namespace Lemoine.Plugin.AutoReasonShiftNoProduction
{
    ...
    , Lemoine.Extensions.AutoReason.IAutoReasonExtension
  {
    ...
    public AutoReasonExtension () : base (Plugin.DEFAULT_REASON_TRANSLATION_KEY, "AutoReason.ShiftNoProduction")
    {
    ...
    protected override void Check ()
    {
      ...
      using (var session = ModelDAOHelper.DAOFactory.OpenSession ()) {
        using (var transaction = session.BeginReadOnlyTransaction ("AutoReason.ShiftNoProduction.Check")) {
    ...
    internal void UpdatePreviousShiftId (int id)
    {
      ...
      log.InfoFormat ("AutoReasonShiftNoProduction: updated '{0}' to '{1}'", GetKey (PREVIOUS_SHIFT_ID), m_previousShiftId);
    ...
    internal void UpdateStartOfShift (DateTime? startOfShift)
    {
      ...
      log.InfoFormat ("AutoReasonShiftNoProduction: updated '{0}' to '{1}'", GetKey (START_OF_SHIFT), m_startShiftDateTime);
