...
namespace Lemoine.Plugin.AutoReasonUniqueMachineModeInShift
{
  ...
  {
    public static readonly string DEFAULT_REASON_TRANSLATION_KEY = "ReasonNoRunningMachineModeInShift";
    ...
    /// Constructor
    /// </summary>
    public Plugin () : base (DEFAULT_REASON_TRANSLATION_KEY, "Inactive shift")
    { }
