  ...
  public class ToolLifeData
  {
    ...
    public class ToolLifeDataItem
    {
      ...
      public class LifeDescription
      {
        ...
        public LifeDescription(string objectStr)
        {
      ...
      readonly IList<LifeDescription> m_lifeDescriptions = new List<LifeDescription>();
      ...
      /// </summary>
      public IList<LifeDescription> LifeDescriptions => m_lifeDescriptions;

      /// <summary>
      /// Override of the [] operator (acts as a getter)
      /// </summary>
      public LifeDescription this[int index] { get { return m_lifeDescriptions[index]; } }
      ...
      {
        m_lifeDescriptions.Add(new LifeDescription());
      ...
      public void AddLifeDescription(LifeDescription lifeDescription)
      {
          ...
          if (split.Length == 2) {
            ...
            case "LifeDescription":
              ...
              foreach (var lifeElt in subSplit) {
                try {
                  m_lifeDescriptions.Add (new LifeDescription (lifeElt));
                } catch(Exception) {
