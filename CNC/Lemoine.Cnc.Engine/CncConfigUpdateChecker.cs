...
namespace Lemoine.CncEngine
{
  ...
  /// </summary>
  public class CncConfigUpdateChecker
    : IConfigUpdateChecker
  {
    readonly ILog log = LogManager.GetLogger (typeof (CncConfigUpdateChecker).FullName);
    ...
    /// Constructor
    /// </summary>
    public CncConfigUpdateChecker (TimeSpan delay)
    {
      m_delay = delay;
    }
