...
namespace Lem_CncDataService
{
  ...
  public class ImportProcessExecution: ProcessClassExecution
  {
    ...
    /// </summary>
    public Lemoine.Cnc.DataImport.ImportCncDataFromQueue ImportCncDataFromQueue { get; set; }
    #endregion // Getters / Setters
    
    /// <summary>
    /// Constructor
    /// </summary>
    public ImportProcessExecution (Lemoine.Cnc.DataImport.ImportCncDataFromQueue importCncDataFromQueue)
